			...
			<div class="modal-dialog">
				...
				<div class="modal-content" style="background-color: #FFFFFF">
					...
					<div class="modal-body" style="text-align: center">
						<div class="div">
							<h2 style="color: red">更改訂房</h2>
							<form method="post" action="modifyBooking">
								<table>
									<tr>
										<td>訂房編號 :</td>
										<td><input style="background-color: #888888" type="text"
											name="id" disabled value="${order.order_id}"></td>
									</tr>
									<tr>
										<td>姓名 :</td>
										<td><input type="text" name="name" value="${order.order_name}"></td>
									</tr>
									<tr>
										<td>手機 :</td>
										<td><input type="text" name="phone" value="${order.order_phone}"></td>
									</tr>
									<tr>
										<td>訂位日期 :</td>
										<td><input type="text" name="date" value="${order.check_in_time}"></td>
									</tr>
									<tr>
										<td>入住天數 :</td>
										<td><input type="text" name="time" value="${order.check_out}"></td>
									</tr>
									<tr>
										<td>訂位人數 :</td>

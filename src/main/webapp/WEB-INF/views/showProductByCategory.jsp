		...
		<c:forEach var="pb" items="${shoppingCart}" begin="0" step="1"
			...
			<div class="prodlist">
				...
				<figcaption>
					...
					<p>
						<fmt:formatNumber type="number" value="${pb.discount}" maxFractionDigits="0" var="discount" />
						discount：<span style="color: #CE0000; font-weight: bold;">${100-discount*10} %off</span>
					</p>
					</c:otherwise>
					</c:choose>
				</figcaption>
	...
	<ul class="pagination justify-content-center">
		...
		<c:forEach begin="1" step="1" end="${listCount}" varStatus="i">
			<li class="page-item"><a class="page-link"
				href="${pageContext.request.contextPath}/shoppingCart/${category}?index=${i.index}">${i.index}</a></li>
		</c:forEach>
